...
export const DECAY_RATES = {
  hunger: 0.00004,     // Reduzido em 60%
  happiness: 0.00003,  // Reduzido em 70%
  energy: 0.0002,      // Reduzido em 60%
  energySleep: 0.005,  // Mantido (taxa de recuperação ao dormir)
  fitness: 0.00004,    // Reduzido em 50%
};
